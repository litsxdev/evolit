import { S, i, y } from './vendor-lit-BQahSIeg.mjs';
import { A, D, l, b } from './vendor-lit-html-DOUE3rsa.mjs';
...
async function importLitHydrationSupport() {
  return import('./vendor-hydration-support-B3KcijgA.mjs');
}
 ...
 */
function installHydrationSupport(loader = importLitHydrationSupport) {
