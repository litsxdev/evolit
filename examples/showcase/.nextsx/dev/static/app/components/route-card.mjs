...
import { LitsxStaticHoistsMixin } from '/_nextsx/shared/litsx__core__elements.mjs';
import { LitElement, css, html } from '/_nextsx/shared/lit.mjs';

const _litsx_static_styles = Symbol("litsx.static.styles");
class RouteCard extends LitsxStaticHoistsMixin(LitElement) {
  static get styles() {
...
export { RouteCard as default };
//# sourceMappingURL=route-card.mjs.map
